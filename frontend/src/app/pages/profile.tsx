...
export function Profile() {
    ...
    const navItems = [
        ...
        { label: "Profile", path: "/profile", icon: <Briefcase className="w-5 h-5" /> },
    ...
    if (!user) return <div className="text-center p-8">Failed to load user data. Please try again.</div>;
    ...
    return (
        <DashboardLayout navItems={navItems} userType={userRole} theme={theme}>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <Card className="p-6 text-center relative">
                        ...
                        <div className="w-24 h-24 mx-auto bg-gradient-to-br from-indigo-600 to-purple-600 rounded-full flex items-center justify-center mb-4">
                            ...
                            <Dialog open={isCertificationDialogOpen} onOpenChange={setIsCertificationDialogOpen}>
                                ...
                                <DialogContent>
                                    ...
                                    <form onSubmit={handleAddCertification} className="space-y-4 py-4">
                                        ...
                                        <Button type="submit" className="w-full bg-indigo-600 hover:bg-indigo-700">Add Certification</Button>
                                    </form>
                                </DialogContent>
                            </Dialog>
                        </div>
                            ...
                            <Dialog open={isSkillDialogOpen} onOpenChange={setIsSkillDialogOpen}>
                                ...
                                <DialogContent>
                                    ...
                                    <form onSubmit={handleAddSkill} className="space-y-4 py-4">
                                        ...
                                        <Button type="submit" className="w-full bg-indigo-600 hover:bg-indigo-700">Add Skill</Button>
                                    </form>
                                </DialogContent>
                            </Dialog>
                        </div>
                            ...
                            <Dialog open={isPortfolioDialogOpen} onOpenChange={setIsPortfolioDialogOpen}>
                                ...
                                <DialogContent>
                                    ...
                                    <form onSubmit={handleAddPortfolio} className="space-y-4 py-4">
                                        ...
                                        <Button type="submit" className="w-full bg-indigo-600 hover:bg-indigo-700">Add Project</Button>
                                    </form>
                                </DialogContent>
                            </Dialog>
                        </div>
                            ...
                            <Dialog open={isEducationDialogOpen} onOpenChange={setIsEducationDialogOpen}>
                                ...
                                <DialogContent>
                                    ...
                                    <form onSubmit={handleAddEducation} className="space-y-4 py-4">
                                        ...
                                        <Button type="submit" className="w-full bg-indigo-600 hover:bg-indigo-700">Add Education</Button>
                                    </form>
                                </DialogContent>
                            </Dialog>
                        </div>
